...
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.SubTrigger>} DropdownMenuSubTriggerElement */
...
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.SubContent>} DropdownMenuSubContentElement */
/** @typedef {import("react").ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubContent>} DropdownMenuSubContentProps */
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.Content>} DropdownMenuContentElement */
/** @typedef {import("react").ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content>} DropdownMenuContentProps */
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.Item>} DropdownMenuItemElement */
/** @typedef {import("react").ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & { inset?: boolean }} DropdownMenuItemProps */
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.CheckboxItem>} DropdownMenuCheckboxItemElement */
/** @typedef {import("react").ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.CheckboxItem>} DropdownMenuCheckboxItemProps */
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.RadioItem>} DropdownMenuRadioItemElement */
/** @typedef {import("react").ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.RadioItem>} DropdownMenuRadioItemProps */
/** @typedef {import("react").ElementRef<typeof DropdownMenuPrimitive.Label>} DropdownMenuLabelElement */
